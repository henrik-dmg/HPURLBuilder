...
public struct PathComponent: URLComponentsModifier {
    ...
    /// Initialises a new instance of `PathComponent` that will append the specified value to the `path` property of `URLComponents`, separated by a slash.
    /// - Parameter pathComponent: the desired path
