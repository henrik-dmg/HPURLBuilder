...
Pod::Spec.new do |spec|
  spec.name         = 'HPURLBuilder'
  spec.version      = '1.0.1'
  spec.summary      = 'A library to construct URLs with an elegant, SwiftUI-like syntax.'

  spec.homepage     = 'https://github.com/henrik-dmg/HPURLBuilder'
  ...
  spec.source = { git: 'https://github.com/henrik-dmg/HPURLBuilder.git', tag: spec.version.to_s }
  spec.source_files = 'Sources/HPURLBuilder/**/*.swift'
